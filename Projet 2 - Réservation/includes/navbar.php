      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block ml-10">
          <div class="flex items-baseline space-x-4">
            <a href="/public/index.php" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors">Accueil</a>
            <a href="/public/reservation.php" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors">Réserver</a>
            <a href="/public/menu.php" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors">Menus</a>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center gap-4">
        <?php if (isset($_SESSION['user_id'])): ?>
          ...
          <div class="relative group">
            ...
            <div id="user-dropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 border border-gray-200 hidden group-hover:block">
              ...
              <a href="/public/mes-reservations/" class="block px-4 py-2 text-sm text-gray-700 hover:bg-amber-50 hover:text-amber-900 transition-colors">Mes réservations</a>
          ...
          <?php if ($_SESSION['user_role'] === 'admin'): ?>
            <div class="relative group ml-3">
              ...
              <div id="admin-dropdown" class="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 border border-gray-200 hidden group-hover:block">
                <a href="./admin/dashboard.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-amber-50 hover:text-amber-900 transition-colors flex justify-between items-center">
                  Tableau de bord
                  <?php if ($adminNotifications > 0): ?>
                    <span class="bg-red-100 text-red-800 text-xs px-2 rounded-full"><?= $adminNotifications ?></span>
                  <?php endif; ?>
                </a>
                <a href="/admin/reservations.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-amber-50 hover:text-amber-900 transition-colors">Gérer les réservations</a>
                <a href="/admin/users.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-amber-50 hover:text-amber-900 transition-colors">Gérer les utilisateurs</a>
        ...
        <?php else: ?>
          ...
          <div class="hidden md:flex items-center gap-3">
            ...
            <a href="/public/register.php" class="bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">Inscription</a>
          </div>
        <?php endif; ?>
    ...
    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
      ...
      <?php if (!isset($_SESSION['user_id'])): ?>
        <div class="px-4 py-2 space-y-2">
          <a href="../login.php" class="w-full flex items-center justify-center bg-gray-800 text-white px-4 py-2 rounded-md text-base font-medium hover:bg-gray-700 transition-colors">Connexion</a>
